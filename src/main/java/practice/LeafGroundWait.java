...
public class LeafGroundWait {
    ...
    public static void main(String[] args) {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//button[@id='j_idt87:j_idt92']")
        )).click();
        ...
        //wait for invisiblex
        wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//button[@id='j_idt87:j_idt92']//span[@class='ui-button-text ui-c'][normalize-space()='Click']")
        )).click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//span[contains(text(),'Click First Button')]")
        )).click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//button[@id='j_idt87:j_idt98']//span[@class='ui-button-text ui-c'][normalize-space()='Click']")
        )).click();
